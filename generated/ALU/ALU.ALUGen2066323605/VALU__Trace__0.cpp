...
void VALU___024root__trace_chg_sub_0(VALU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        tracep->chgCData(oldp+39,((1U & (~ (vlSelf->ALU__DOT__A_in_not 
                                            >> 0x1fU)))),6);
        tracep->chgCData(oldp+40,(vlSelf->ALU__DOT__count_30),6);
        tracep->chgCData(oldp+41,(vlSelf->ALU__DOT__count_29),6);
        tracep->chgCData(oldp+42,(vlSelf->ALU__DOT__count_28),6);
        tracep->chgCData(oldp+43,(vlSelf->ALU__DOT__count_27),6);
        tracep->chgCData(oldp+44,(vlSelf->ALU__DOT__count_26),6);
        tracep->chgCData(oldp+45,(vlSelf->ALU__DOT__count_25),6);
        tracep->chgCData(oldp+46,(vlSelf->ALU__DOT__count_24),6);
        tracep->chgCData(oldp+47,(vlSelf->ALU__DOT__count_23),6);
        tracep->chgCData(oldp+48,(vlSelf->ALU__DOT__count_22),6);
        tracep->chgCData(oldp+49,(vlSelf->ALU__DOT__count_21),6);
        tracep->chgCData(oldp+50,(vlSelf->ALU__DOT__count_20),6);
        tracep->chgCData(oldp+51,(vlSelf->ALU__DOT__count_19),6);
        tracep->chgCData(oldp+52,(vlSelf->ALU__DOT__count_18),6);
        tracep->chgCData(oldp+53,(vlSelf->ALU__DOT__count_17),6);
        tracep->chgCData(oldp+54,(vlSelf->ALU__DOT__count_16),6);
        tracep->chgCData(oldp+55,(vlSelf->ALU__DOT__count_15),6);
        tracep->chgCData(oldp+56,(vlSelf->ALU__DOT__count_14),6);
        tracep->chgCData(oldp+57,(vlSelf->ALU__DOT__count_13),6);
        tracep->chgCData(oldp+58,(vlSelf->ALU__DOT__count_12),6);
        tracep->chgCData(oldp+59,(vlSelf->ALU__DOT__count_11),6);
        tracep->chgCData(oldp+60,(vlSelf->ALU__DOT__count_10),6);
        tracep->chgCData(oldp+61,(vlSelf->ALU__DOT__count_9),6);
        tracep->chgCData(oldp+62,(vlSelf->ALU__DOT__count_8),6);
        tracep->chgCData(oldp+63,(vlSelf->ALU__DOT__count_7),6);
        tracep->chgCData(oldp+64,(vlSelf->ALU__DOT__count_6),6);
        tracep->chgCData(oldp+65,(vlSelf->ALU__DOT__count_5),6);
        tracep->chgCData(oldp+66,(vlSelf->ALU__DOT__count_4),6);
        tracep->chgCData(oldp+67,(vlSelf->ALU__DOT__count_3),6);
        tracep->chgCData(oldp+68,(vlSelf->ALU__DOT__count_2),6);
        tracep->chgCData(oldp+69,(vlSelf->ALU__DOT__count_1),6);
        tracep->chgCData(oldp+70,((0x3fU & (((IData)(vlSelf->ALU__DOT__tocount_1) 
                                             & (~ vlSelf->ALU__DOT__A_in_not))
                                             ? ((IData)(1U) 
